...
const (
	...
	IdeVersion     = "0.1.58" // 对齐 connectedGraph/traework2api 上游，对应更新更全的模型配置表（含 glm-5.3）
	IdeVersionCode = "20260820"
	DeviceBrand    = "NDZ-WXX9"   // 设备机型示例（指纹头用，可替换为真实机型，无需精确匹配）
	OSVersion      = "Windows 11 Pro" // 真实客户端系统版本
